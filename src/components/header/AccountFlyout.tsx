...
import { ChevronDown, User, Package, MapPin, Heart, LogOut, FileText } from 'lucide-react';
    ...
    >
      ...
      {isOpen && (
        <div
          ...
          className="absolute right-0 top-full mt-2 w-80 sm:w-96 bg-white rounded-md shadow-2xl border border-gray-200 text-gray-900 z-[95] overflow-hidden animate-in fade-in zoom-in-95 duration-150 select-none"
        >
          ...
          {!isLoggedIn ? (
            /* =========================================================================
             * Task 18: Logged-Out / Guest View
             * ========================================================================= */
            <div className="p-4 space-y-3">
              {/* Sign In CTA Button */}
              <div className="text-center space-y-1.5 pb-3 border-b border-gray-100">
                <button
                  type="button"
                  onClick={handleSignInClick}
                  className="w-full py-2 px-4 bg-[#ffd814] hover:bg-[#f7ca00] active:bg-[#f0b800] text-gray-950 font-bold rounded border border-[#fcd200] shadow-sm text-xs transition-all cursor-pointer"
                >
            ...
            /* =========================================================================
             * Task 19: Logged-In Personalized View
             * ========================================================================= */
            <div className="p-4 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-4 pt-1">
                ...
                <div className="space-y-2 border-r border-gray-100 pr-2">
                  ...
                  <Link
                    href="/wishlist"
                    onClick={() => setIsOpen(false)}
                    className="flex items-center gap-1.5 text-xs text-gray-700 hover:text-amber-600 hover:underline"
                  >
                  ...
                  <Link
                    href="/history"
                    onClick={() => setIsOpen(false)}
                    className="block text-xs text-gray-700 hover:text-amber-600 hover:underline"
                  >
                    {dict.account.recentBrowsed}
                  </Link>
                </div>
                ...
                <div className="space-y-2 pl-1">
                  ...
                  >
                    ...
                    <span>{dict.account.savedAddresses}</span>
                  </Link>
                  <Link
                    href="/invoices"
                    onClick={() => setIsOpen(false)}
                  ...
                  >
                    ...
                    <span>{dict.account.gstInvoices}</span>
                  </Link>
                </div>
              </div>
