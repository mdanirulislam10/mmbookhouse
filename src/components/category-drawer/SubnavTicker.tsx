  ...
  return (
    <div className={`flex items-center gap-2 text-xs select-none ${className}`}>
      ...
      {showEmergencyNotice && activeNotice && (
        ...
        >
          ...
          {activeNotice.href ? (
            ...
            <span className="truncate max-w-[280px]">{activeNotice.text}</span>
          )}
        </div>
      )}
      ...
      <Link
        ...
        aria-label="মালদা স্টুডেন্ট হাব ও বিশেষ নোটিশ"
      ...
      >
        ...
        <span className="hidden sm:inline">মালদা স্টুডেন্ট হাব</span>
        <span className="sm:hidden text-[11px]">মালদা</span>
